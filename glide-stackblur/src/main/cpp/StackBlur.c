...
JNIEXPORT void JNICALL Java_cn_gavinliu_android_lib_glide_stackblur_BlurUtils_bitmapToBlur(JNIEnv *env,
                                                                              jclass clzz,
                                                                              jobject bitmapOut,
                                                                              jint radius,
                                                                              jint threadCount,
